/*
 * HIP11 uncore perf_event encoding
 *
 * Uses sysfs PMU type from perf_name (exact c920fn2 device name).
 * Same config-field model as Kunpeng/tsv200 uncore.
 */
...
int
pfm_hip11_unc_get_perf_encoding(void *this, pfmlib_event_desc_t *e)
{
